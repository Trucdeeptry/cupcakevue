...
export default {
  ...
  actions: {
    async getAccount(context) {
      ...
      try {
        const reponse = await fetch(
          `${import.meta.env.VITE_API_URL}/api/khachhang`
        );
    ...
    async addItem(context, {info, disableToast}) {
      ...
      await fetch(`${import.meta.env.VITE_API_URL}/api/khachhang`, {
        method: 'POST',
        headers: {
    ...
    async deleteItem(context, payload) {
      const toast = getToastInstance();
      await fetch(
        `${import.meta.env.VITE_API_URL}/api/khachhang/${payload}`,
        {
          method: 'DELETE',
          headers: {
            'Content-Type': 'application/json',
    ...
    async updateItem(context, payload) {
      const toast = getToastInstance();
      await fetch(
        `${import.meta.env.VITE_API_URL}/api/khachhang/${payload._id}`,
        {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
