          ...
          >
            <div>
              ...
              >
                ...
                <strong>{{ projects.length }} in process</strong> this month
              </p>
            </div>
            <button
              aria-expanded="false"
                    ...
                    <div class="w-10/12">
                      ...
                      >
                        <div
                          ...
                          :class="{
                            'from-green-600 to-green-400': item.complete == 100,
                          }"
  ...
  computed: {
    ...
    grandTotal() {
      const total = this.order.reduce(
        (total, order) => total + order.tong_tien,
        0
      );
